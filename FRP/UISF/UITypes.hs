...
mergeLayout :: (Flow -> Layout) -> (Flow -> Layout) -> Flow -> Layout
mergeLayout fl1 fl2 f = case (fl1 f, fl2 f) of
  (NullLayout, l2) -> l1
  (l1, NullLayout) -> l2
  (Layout n m u v minw minh lFill) (Layout n' m' u' v' minw' minh' lFill') -> case f of
